...
Run React Doctor on the web app and triage findings. Fix true positives only if the user asks.
...
2. Classify true positive / false positive / needs-human-review.
